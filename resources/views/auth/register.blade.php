                    ...
                    <form method="POST" action="{{ route('register.store') }}"
                        ...
                        <div class="form-bg col-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="tel" id="input_phone" class="form-control mt-2 d-none"
                                        pattern="[0-9]{10}" maxlength="10" placeholder="กรอกเบอร์โทรศัพท์ 10 หลัก">
                                </div>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <textarea name="address" id="address" class="form-control" rows="2" placeholder="กรอกที่อยู่" required></textarea>
                            </div>
                            ...
                            <div class="mt-3 text-center">
                                ...
                                <button type="submit" class="btn w-100 p-2">
                                    <img src="../img/register/Register-Button.png" alt="button" class="img-fluid w-100">
                                </button>
                            </div>
                        </div>
                    </form>
